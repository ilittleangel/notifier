...
trait Eithers {
  ...
  val separator = "; "
  private val concatStrings: (String, String) => String = (s1, s2) => s1 + separator + s2
  ...
  private val concatLeft: (Either[String, String], Either[String, String]) => Left[String, Nothing] = (acc, curr) => {
    curr match {
  ...
  private val concatRight: (Either[String, String], Either[String, String]) => Either[String, String] = (acc, curr) => {
    curr match {
